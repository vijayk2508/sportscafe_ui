...
const validationSchema = yup.object({
    sportName: yup.string('Enter Sport Name').required('Email is required'),
    ...
    author: yup.string('Enter Content').required('Content is required'),
    img: yup.mixed('Enter image').required('image is required'),
})
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, { setSubmitting, resetForm }) => {
            ...
            const response = await axios
                .post(API.BASE_URL + '/article/insertArticle', formData)
                .catch(err => {
